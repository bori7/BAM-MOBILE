...
import { HandsPrayingSVG } from "../../../shared/components/SVGS";
...
const PrayerListView = ({ prayers, onPressPrayerFunc }: IProps) => {
  return (
    <>
      <View
        style={[
      ...
      >
        {prayers?.length == 0 && (
          <>
            <HandsPrayingSVG
              color={COLORS.Light.tickGray}
              height={70}
              width={70}
            />
            <Text style={styles.textEmpty}>
              You have not added any prayers yet. Click the button below and add
              your prayers
            </Text>
          </>
        )}
