          ...
          >
            <View style={styles.r3}>
              ...
              <Text style={styles.r3h1}>
                {activeSubscriptionData?.subscriptionType} Subscription
              </Text>
              <Text style={styles.r3h2}>
                You have an active annual subscription
              </Text>
              <View style={styles.r3a}>
                <Text style={styles.r3at1}>Subscription type</Text>
                <Text style={styles.r3at2}>
                  {activeSubscriptionData?.subscriptionType}
                </Text>
              </View>
              <View style={styles.r3a}>
                <Text style={styles.r3at1}>Date of next subscription</Text>
                <Text style={styles.r3at2}>
              ...
              <View style={styles.r3a}>
                ...
                <Text style={styles.r3at2}>
                  NGN {activeSubscriptionData?.amountPaid}
                </Text>
              </View>
              <View style={styles.r3a}>
                <Text style={styles.r3at1}>Payment method</Text>
                <Text style={styles.r3at2}>
                  {activeSubscriptionData?.paymentMethod}
                </Text>
              </View>
            </View>
