...
type NavigationProps = AuthProps<AuthRoutes.DaSB>;

const DaSB: React.FC<NavigationProps> = ({ navigation }) => {
  return (
    <View style={styles.main}>
      <StatusBar barStyle="light-content" />
      <ImageBackground style={styles.container} source={IMAGES.splashScreen2}>
        <View style={styles.subContainer}>
          ...
          <View style={styles.r3}>
            <Text style={styles.r3t}>
              Daily Devotionals to Seek God Intimately
            </Text>
          </View>
          <View style={styles.r4}>
            <Text style={styles.r4t}>
              Nurture Your Relationship with God Each Day with Daily Devotionals
            </Text>
          </View>
