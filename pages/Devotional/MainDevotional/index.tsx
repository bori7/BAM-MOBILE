                    ...
                    >
                        ...
                        <View style={styles.v2}>
                            ...
                            >
                                ...
                                {/*/>*/}
                                <Image
                                    source={devotionals[0]?.image?.uri ? devotionals[0]?.image : IMAGES.devotionalSample1}
                            ...
                            <View style={styles.v2r2}>
                                <View style={styles.v2r2a}>
                                    <View style={styles.v2r2aC1}>
                                        <Text
                                            style={styles.v2r2t1}>{devotionals[0]?.date || `September 22, 2023`}</Text>
                                        <Text
                                            style={styles.v2r2t2}>{devotionals[0]?.title || `SHARING YOUR FAITH`}</Text>
                                    </View>
                                    <TouchableOpacity style={styles.v2r2aC2}>
                                        <MidDoubleTick
                                            fill={userDevotional?.readIds.includes(devotionals[0]?.uid)
                                ...
                                <Text style={styles.v2r2t}>
                                    {devotionals[0]?.text || `The Apostles went everywhere to share their faith in Christ.
