...
const EmailClockModal = ({ pickSelectedTime }: IProps) => {
  ...
  const onTimeChange = (event: any, selectedDate: Date | undefined) => {
    ...
    pickSelectedTime(selectedDate?.toISOString() || new Date().toISOString());
  };
  ...
  const handleConfirm = (selectedDate: Date) => {
    ...
    setSelectedDob(formattedTime);
    // pickSelectedTime(formattedTime);
    pickSelectedTime(selectedDate.toISOString());
    hideDatePicker();
...
export default EmailClockModal;
