...
type NavigationProps = MoreProps<MoreRoutes.PushNotifications>;

const PushNotifications: React.FC<NavigationProps> = ({
  navigation,
  route,
}) => {
  ...
  const { generalPushNotificationForms: generalNotificationForms } =
    generalState;
  ...
  useEffect(() => {
    const notificationsFormTemp: NotificationsFormType[] = Object.keys(
      ...
      setTimeValue: (val) => {
        dispatch(
          generalActions.updatePushNotificationsForm({
            name: form,
        ...
        <View style={[styles.headerContainer, styles.headerShadow]}>
          <View style={styles.header}>
            <View style={styles.headerC1}>
              ...
              <Text style={styles.r1t2}>Push Notification</Text>
            </View>
          </View>
        </View>
