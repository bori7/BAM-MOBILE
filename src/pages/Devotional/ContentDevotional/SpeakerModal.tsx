...
export type ISpeedsProps = {
    name: ISpeedProps;
};
export type IVoicesProps = {
    name: IVoiceProps;
};

interface ISpeakerModal {
    handleSpeed: (val: ISpeedProps) => void,
    handleVoice: (val: IVoiceProps) => void,
    play: boolean,
    togglePlay: () => void
}

const SpeakerModal = ({handleSpeed, handleVoice, play, togglePlay}: ISpeakerModal) => {
    const cWidth = 23;
    ...
    return (
        <>
            ...
            <View style={styles.mr3}>
                ...
                >
                    <Text style={styles.mr3a}>{speed}x</Text>
                </TouchableOpacity>
                                ...
                                {speeds.map((option, idx) => (
                                    <TouchableOpacity
                                        ...
                                        onPress={() => {
                                            ...
                                            handleSpeed(option.name)
                                        }}
                                    >
                                        <Text style={styles.optionSText}>{option.name}x</Text>
                                        {option.name === speed && (
                                            <Feather
                                                name="check"
                                                size={24}
