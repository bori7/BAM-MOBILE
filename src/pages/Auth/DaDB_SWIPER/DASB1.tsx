                ...
                <View style={styles.subContainer}>
                    ...
                    <View style={styles.r3}>
                        <Text style={styles.r3t}>
                            A Daily Devotional to Seek God Intimately
                        </Text>
                    </View>
                    <View style={styles.r4}>
                        <Text style={styles.r4t}>
                            Include Daily Application, Memory Verse and Prayer Points
                        </Text>
                    </View>
                    <View style={styles.r4}>
                        <Text style={styles.r4t}>
                            Nurture Your Relationship with God Each Day with The Daily Answer
                        </Text>
                    </View>
